...
#ifndef IMC_FLUORESCENTDISSOLVEDORGANICMATTER_HPP_INCLUDED_
#define IMC_FLUORESCENTDISSOLVEDORGANICMATTER_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    static FluorescentDissolvedOrganicMatter*
    cast(Message* msg__)
    {
      return (FluorescentDissolvedOrganicMatter*)msg__;
    }

    FluorescentDissolvedOrganicMatter(void)
    {
      m_header.mgid = FluorescentDissolvedOrganicMatter::getIdStatic();
      clear();
    }
